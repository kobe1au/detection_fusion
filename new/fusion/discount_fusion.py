...
class DiscountProbabilityFusion(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        # ``api_observed_support`` remains in the call signature because it is
        # produced by the shared API encoder.  Fixed evidential comparisons do
        # not consume it.
        del api_observed_support
        if not (
    ...
    def _forward_fp32(
        ...
        predictive_beliefs: list[torch.Tensor] = []
